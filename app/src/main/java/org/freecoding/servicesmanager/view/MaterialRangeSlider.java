...
public class MaterialRangeSlider extends View {
    ...
    private void getDefaultColors() {
        ...
        colorControlNormal = materialStyledAttrs.getColor(0, Color.parseColor("#ff0099cc"));
        colorControlHighlight = materialStyledAttrs.getColor(1, Color.parseColor("#ff000000"));
